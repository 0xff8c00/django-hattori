...
@api_v2.get("events")
def newevents2(request) -> Annotated[Response[str], 200]:
    return Response(200, "events are gone")
...
@api_v3.get("events")
def newevents3(request) -> Annotated[Response[str], 200]:
    return Response(200, "events are gone 3")


@api_v3.get("foobar")
def foobar(request) -> Annotated[Response[str], 200]:
    return Response(200, "foobar")


@api_v3.post("foobar")
def post_foobar(request) -> Annotated[Response[str], 200]:
    return Response(200, "foobar")


@api_v3.put("foobar", url_name="foobar_put")
def put_foobar(request) -> Annotated[Response[str], 200]:
    return Response(200, "foobar")
